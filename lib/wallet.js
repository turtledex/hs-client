...
class WalletClient extends Client {
   ...
   * {@see hsd/lib/covenants/namestate/NameState}
   * @param {String} id
   * @param {String} name
   * @returns {Promise}
   */
  ...
  getNames(id) {
    return this.get(`/wallet/${id}/names`);
  }
   ...
   * for the given name.
   * {@see hsd/lib/covenants/namestate/NameState}
   * {@see hsd/lib/wallet/txdb/BlindBid}
   * {@see hsd/lib/wallet/txdb/BidReveal}
   * @param {String} id
   * @param {String} name
   * @returns {Promise}
   */
  ...
  getAuctions(id) {
    return this.get(`/wallet/${id}/auction`);
  }

  /**
   * Get wallet bid for a given name.
   * {@see hsd/lib/wallet/txdb/BlindBid}
   * @param {String} id
   * @param {String?} name
   * @param {Object?} options
  ...
  getBid(id, name, options) {
    return this.get(`/wallet/${id}/bid/${name}`, options);
  }

  /**
   * Get wallet bids for all names
   * the wallet manages.
   * {@see hsd/lib/wallet/txdb/BlindBid}
   * @param {String} id
   * @param {String?} name
  ...
  /**
   * Get name resource.
   * {@see hsd/lib/dns/resource/Resource}
   * @param {String} id
   * @param {String} name
   * @returns {Promise}
   */
...
class Wallet extends EventEmitter {
  ...
  getAuction(name) {
    return this.client.getAuction(this.id, name);
  }
  ...
  getAuctions() {
    return this.client.getAuctions(this.id);
  }
  ...
  getBid(name, options) {
    return this.client.getBid(this.id, name, options);
  }
  ...
  getReveal(name, options) {
    return this.client.getReveal(this.id, name, options);
  }
