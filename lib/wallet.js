...
class WalletClient extends Client {
  ...
  getBid(id, name, own) {
    return this.get(`/wallet/${id}/bid/${name}`, { own });
  }
  ...
  getReveal(id, name, own) {
    return this.get(`/wallet/${id}/reveal/${name}`, { own });
  }
...
class Wallet extends EventEmitter {
   ...
   * @param {String?} name
   * @param {Boolean?} own
   * @returns {Promise} - Returns {@link BlindBid}
   */

  getBid(name, own) {
    return this.client.getBid(this.id, name, own);
  }
  ...
  getReveal(name, own) {
    return this.client.getReveal(this.id, name, own);
  }
